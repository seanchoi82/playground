	...
	<div class="body"> 
		<aside>
			<ul class="ui-box ui-box-white ui-box-shadow">
				...
				<li class="select"><a href="noticeList.html">공지사항 조회</a></li>
		...
		<div class="content">
			<div class="ui-box ui-box-white ui-box-shadow">
				<!-- Content 시작 -->
				<h2 class="icon-arrow-green">공지사항 목록 조회</h2>
				...
				<div class="pt30">
					<table class="tbl_nor" cellspacing="0" summary="회원 검색조건">
						...
						<tr>
							<th>제목</th>
							<td><input type="text" id="cond_title" name="cond_title"></td>
							<th>내용</th>
				...
				<div class="pt30">
					<table class="tbl_nor" cellspacing="0" summary="공지사항조회">
						<caption>공지사항조회</caption>
						<colgroup>
							<col width="100">
							<col width="100">
							<col width="150">
...
<script type="text/javascript">
	//신규등록
	function add() {
		location.href="/missingu/admin/noticeEdit.html?actionType=add";
	}
	...
	function searchCnt() {
		$.ajax({
			url : "/missingu/admin/getNoticeListCnt.html",
			type : "POST",
			cache : false,
	...
	function search() {
		$.ajax({
			url : "/missingu/admin/getNoticeList.html",
			type : "POST",
			cache : false,
			data : $("#searchForm").serialize(),
			dataType : "json",
			success : function(data) {
				...
				if(rsltCd == 0) { //조회성공
					var noticeList = data.response.noticeList;
					var htmls = "";
					$.each(noticeList, function(i){
						htmls +="<tr class=\"desc\">";
						htmls +="	<td>"+this.noticeId+"</td>";
						htmls +="	<td><a href='/missingu/admin/noticeEdit.html?actionType=modify&noticeId=" +this.noticeId+"'>"+this.title+"</a></td>";
						htmls +="	<td>"+this.showYn+"</td>";
						htmls +="	<td>"+this.readCnt+"</td>";
