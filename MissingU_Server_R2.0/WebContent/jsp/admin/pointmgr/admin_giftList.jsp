	...
	<div class="body">
		...
		<div class="content">
			<div class="ui-box ui-box-white ui-box-shadow">
				<!-- Content 시작 -->
				<h2 class="icon-arrow-green">선물(꽃다발) 조회</h2>
				...
				<div class="ui-btns alignLeft">
					<button id="btn_gift_send" data-click-callback="giftSend()">선물(꽃다발)보내기</button>
				</div>
				
				
				<div class="pt30">
					<table class="tbl_nor" cellspacing="0" summary="선물(꽃다발)내역">
						<caption>선물(꽃다발)내역</caption>
						<colgroup>
							<col width="200">
							<col width="200">
							<col width="200">
						...
						<c:forEach items="${ response.dataList }" var="item">
							<tr>
								...
								<td class="ct">
									<button id="btn-cancle" data-click-callback="giftCancel('${ item.id }')">삭제</button>
								</td>
							</tr>
						</c:forEach>
					</table>
			...
			<jsp:include page="/jsp/common/paging.jsp">
			    <jsp:param name="actionPath" value="giftList.html"/>
