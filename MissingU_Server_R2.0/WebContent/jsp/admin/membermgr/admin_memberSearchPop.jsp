...
<script type="text/javascript">
	...
	function bind(memberId, nickName, country, lang, photoUrl) {
		$(opener.location).attr("href", "javascript:rebind('" + $("#token").val() + "', '" +memberId+"', '" + nickName+"', '" + country+"', '" + lang+"', '" + photoUrl+"');");
		self.close();
	}		
			...
			success : function(data) {
				...
				if(rsltCd == 0) { //조회성공
					...
					$.each(memberList, function(i){
						...
						htmls +="	<td><img src='" + this.mainPhotoUrl + "' class='profile-img'/></td>";
						htmls +="	<td><a href=\"javascript:bind('" +this.memberId+"', '" +this.nickName+"', '" +this.country+"', '" +this.lang+"', '" +this.mainPhotoUrl+"')\">"+this.loginId+"</a></td>";
