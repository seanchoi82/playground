	...
	<div class="body">
		<aside>
			<ul class="ui-box ui-box-white ui-box-shadow">
				<li><a href="apkList.html">MissingU APK/공지</a></li>
				<li class="select"><a href="apkListRandomChat.html">채팅 APK/공지</a></li>
			</ul>
		</aside>
		<div class="content">
			<div class="ui-box ui-box-white ui-box-shadow">
				...
				<form name="search" id="search" method="post" action="apkUpgradeConfirmRandomChat.html" onsubmit="return checkApkUpgrade();">
				<div class="rbox">
					<ul class="search">
				...
				<form name="search2" id="search2" method="post" action="emrNoticeConfirmRandomChat.html" onsubmit="return checkEmrNotice();">
				<div class="rbox">
					<ul class="search">
...
<script type="text/javascript">
	function apkList() {
		location.href="/missingu/admin/apkListRandomChat.html";
	}
	
	function apkAdd() {
		location.href="/missingu/admin/apkAddRandomChat.html";
	}
	
	function deleteApk(apkId) {
		if(confirm("삭제하시겠습니까?")) {
			location.href="/missingu/admin/apkDeleteRandomChat.html?apkId="+apkId;
		}
	}
	...
	$(".reload").change(function() {
		location.href='apkListRandomChat.html?lang=' + $(this).val();
	});
